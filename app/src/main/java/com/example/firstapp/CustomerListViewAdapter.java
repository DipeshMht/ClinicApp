...
public class CustomerListViewAdapter extends AppCompatActivity<RowItem> {

    Context context;

    public CustomerListViewAdapter(Context context, int resourceId, List<RowItem> items) {
