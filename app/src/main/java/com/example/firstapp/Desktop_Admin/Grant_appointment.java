...
import com.example.firstapp.CustomerListViewAdapter;
import com.example.firstapp.DatabaseHelper;
import com.example.firstapp.R;
import com.example.firstapp.RowItem;
...
public class Grant_appointment extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_grant_appointment);
        ...
        if (y.moveToFirst()) {
            ...
            CustomerListViewAdapter adapter = new CustomerListViewAdapter(this, R.layout.custom_adapter, rowItems);
